...
use DC\CRMBundle\Entity\Account;
use DC\CRMBundle\Form\AccountType;
...
class AccountController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('DCCRMBundle:Account')->findAll();

        return $this->render('DCCRMBundle:Account:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('DCCRMBundle:Account:new.html.twig', array(
            'entity' => $entity,
    ...
    */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('DCCRMBundle:Account')->find($id);
        ...
        return $this->render('DCCRMBundle:Account:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('DCCRMBundle:Account:edit.html.twig', array(
            'entity'      => $entity,
